...
__all__ = [
    'Kind_clusterKindConfig',
    'Kind_clusterKindConfigNetworking',
    'Kind_clusterKindConfigNode',
    'Kind_clusterKindConfigNodeExtraMount',
    'Kind_clusterKindConfigNodeExtraPortMapping',
]

@pulumi.output_type
class Kind_clusterKindConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in Kind_clusterKindConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        Kind_clusterKindConfig.__key_warning(key)
    ...
    def __init__(__self__, *,
                 ...
                 networking: Optional['outputs.Kind_clusterKindConfigNetworking'] = None,
                 nodes: Optional[Sequence['outputs.Kind_clusterKindConfigNode']] = None):
    ...
    @property
    @pulumi.getter
    def networking(self) -> Optional['outputs.Kind_clusterKindConfigNetworking']:
        return pulumi.get(self, "networking")

    @property
    @pulumi.getter
    def nodes(self) -> Optional[Sequence['outputs.Kind_clusterKindConfigNode']]:
        return pulumi.get(self, "nodes")


@pulumi.output_type
class Kind_clusterKindConfigNetworking(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in Kind_clusterKindConfigNetworking. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        Kind_clusterKindConfigNetworking.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class Kind_clusterKindConfigNode(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "extraMounts":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in Kind_clusterKindConfigNode. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        Kind_clusterKindConfigNode.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 extra_mounts: Optional[Sequence['outputs.Kind_clusterKindConfigNodeExtraMount']] = None,
                 extra_port_mappings: Optional[Sequence['outputs.Kind_clusterKindConfigNodeExtraPortMapping']] = None,
    ...
    def extra_mounts(self) -> Optional[Sequence['outputs.Kind_clusterKindConfigNodeExtraMount']]:
        return pulumi.get(self, "extra_mounts")

    @property
    @pulumi.getter(name="extraPortMappings")
    def extra_port_mappings(self) -> Optional[Sequence['outputs.Kind_clusterKindConfigNodeExtraPortMapping']]:
...
@pulumi.output_type
class Kind_clusterKindConfigNodeExtraMount(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in Kind_clusterKindConfigNodeExtraMount. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        Kind_clusterKindConfigNodeExtraMount.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class Kind_clusterKindConfigNodeExtraPortMapping(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in Kind_clusterKindConfigNodeExtraPortMapping. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        Kind_clusterKindConfigNodeExtraPortMapping.__key_warning(key)
        return super().__getitem__(key)
